...
import com.michael.statussaverstatusdownloader.databinding.ActivityVideoPlayerBinding
...
//            supportActionBar?.setDisplayHomeAsUpEnabled(true)
            ...
            adapter = MediaPlayerAdapter(list, this@VideoPlayerActivity)
    ...
    private fun updatePlaybackBasedOnVisibility() {
        ...
        if (maxVisibility > 0.5f) {
            adapter.playVideoAtPosition(maxVisibleItem)
        } else {
            adapter.pauseAllPlayers()
        }
    }
