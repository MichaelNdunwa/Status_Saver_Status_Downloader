...
import com.michael.statussaverstatusdownloader.databinding.ItemAudioPlayerBinding
...
class AudioPlayerAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemAudioPlayerBinding.inflate(
    ...
    fun playAudioAtPosition(position: Int) {
    ...
    inner class ViewHolder(private val binding: ItemAudioPlayerBinding) :
